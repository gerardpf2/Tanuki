...
{
    public class InitializeGameplayUseCase : IInitializeGameplayUseCase
    {
        ...
        public InitializeGameplayUseCase(
        ...
        private void InitializeModel(string id)
        {
        ...
        private void InitializeView()
        {
            ...
            _swapCurrentNextPlayerInputActionHandler.Initialize();
