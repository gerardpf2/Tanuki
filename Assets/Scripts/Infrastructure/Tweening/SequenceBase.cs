...
namespace Infrastructure.Tweening
{
    public abstract class SequenceBase : TweenBase
    {
        ...
        protected SequenceBase(
            ...
            Action onRestart,
            Action onComplete,
            [NotNull, ItemNotNull] IEnumerable<ITween> tweens) : base(autoPlay, delayBeforeS, delayAfterS, repetitions, repetitionType, delayManagementRepetition, delayManagementRestart, onStartIteration, onStartPlay, onPlaying, onEndPlay, onEndIteration, onPause, onResume, onRestart, onComplete)
        {
