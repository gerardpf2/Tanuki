...
It contains code that could be used to create multiple completely different games. Ideally it could have its own repository and be used as a package, subtree or submodule. This is something I may consider doing in the future. Also, it is being updated and extended as game needs change. This is why some of its parts are not finished yet
...
- <b>Tweening</b>: My own tweening framework! Define and run tweens and sequences to update game entities. Click [here](https://github.com/gerardpf2/Tanuki/tree/infrastructure-main/Assets/Scripts/Infrastructure/Tweening) for more info
