...
namespace Editor.Tests.Infrastructure.DependencyInjection
{
    public class ScopeTests
    {
        ...
        public void SetUp()
        {
            ...
            _scope = new Scope(_privateRuleAdder, _publicRuleAdder, _publicRuleGetter, _ruleResolver, _initialize);
        }
        ...
        public void Scope_HasValidParams()
        {
            ...
            Assert.AreSame(_publicRuleGetter, _scope.PublicRuleGetter);
        ...
        {
            PartialScope partialScope = new(_scope, null, null, null, null, null);
        ...
        {
            PartialScope partialScope1 = new(_scope, null, null, null, null, null);
            PartialScope partialScope2 = new(_scope, null, null, null, null, null);
        ...
        {
            Scope childScope1 = new(null, null, null, null, null);
            Scope childScope2 = new(null, null, null, null, null);
