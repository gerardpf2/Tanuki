...
namespace Editor.Tests.Infrastructure.DependencyInjection
{
    public class ScopeInitializerTests
    {
        ...
        public void Initialize_PartialScope_InitializeCalledWithValidParams()
        {
            ...
            PartialScope partialScope = new(mainScope, null, null, null, _ruleResolver, _initialize);
        ...
        {
            Scope scope = new(null, null, null, _ruleResolver, _initialize);
        ...
        public void Initialize_HasChild_ChildScopeInitializeCalledWithValidParams()
        {
            ...
            Scope childScope = new(null, null, null, _ruleResolver, _initialize);
