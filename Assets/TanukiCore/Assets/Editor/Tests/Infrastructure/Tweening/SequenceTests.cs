...
namespace Editor.Tests.Infrastructure.Tweening
{
    public class SequenceTests
    {
        ...
        {
            Sequence sequence = Build();
            SequenceAsync other = new(true, 0.0f, 0.0f, 0, RepetitionType.Restart, DelayManagement.BeforeAndAfter, DelayManagement.BeforeAndAfter, null, null, null, null, null, null, null, null, _tweens);
